      ...
      <div className="border-b border-[#EDEDED]/10 bg-[#0A0A0A]">
        <div className="max-w-[896px] mx-auto px-6 py-8">
          <div className="space-y-4">
            <Link href="/dashboard">
              <Button variant="ghost" size="sm" className="text-[#EDEDED]/70 hover:text-[#EDEDED] hover:bg-[#EDEDED]/10 mb-2">
                <ArrowLeft className="h-4 w-4 mr-2" />
                Back to Dashboard
              </Button>
            </Link>
            <div>
              <h1 className="text-3xl font-bold">CID Details</h1>
              <div className="flex items-center space-x-2 mt-3">
                <code className="text-lg bg-[#EDEDED]/10 px-3 py-2 rounded font-mono">
                ...
                {cidData ? (
                  <>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div className="space-y-1">
                        <Label className="text-xs text-[#EDEDED]/60">Timeout (sec)</Label>
              ...
              <CardContent className="space-y-4">
                ...
                {mockEvidencePacks[selectedPack] && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-1">
                        {mockEvidencePacks[selectedPack].probes.map((probe, probeIndex) => (
                          <div 
                            key={probeIndex}
                            className="flex items-center justify-between p-2 bg-[#EDEDED]/5 rounded"
                          >
                            <div className="flex items-center space-x-2">
                              {probe.ok ? (
                              ...
                              <span className="text-xs text-[#EDEDED]/60">{probe.gateway}</span>
                            </div>
                    ...
                    {/* Pack CID */}
                    <div className="p-3 bg-[#EDEDED]/5 rounded">
